...
TrainVoc is a vocabulary training application designed to help users improve their language skills
by practicing words categorized by levels or exams. The app uses a database of words and provides
various quiz types to enhance learning.
...
Unit tests are written to verify the functionality of ViewModels and repositories. Example tests
include:
