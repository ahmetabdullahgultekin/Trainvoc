...
- **Unit tests are FULLY GREEN** — 246 tests, 0 failures (#222 fixed compile/run, #223 fixed the 30 runtime failures on 2026-07-15: missing MainDispatcherRule, ICU DateFormat on plain JVM → Robolectric, mockito matcher misuse, SharedFlow races → Turbine).
